        ...
        <div className="flex flex-col items-center gap-6 pt-4">
          ...
          <div className="w-full flex flex-col gap-3">
            {[
              ...
              >
                {item.icon}
                <span style={{ fontFamily: "'Poppins:Medium'", fontSize: 15 }}>
                  {item.label}
                </span>
              </button>
            ))}
      ...
      <SubPage title="Editar Nome">
        <div className="flex flex-col gap-5">
          <ProfileInput
            label="Nome"
            value={s.nameEdit}
            onChange={(v) => s.setNameEdit(v)}
          />
          <ProfileCTA
            label="Salvar"
            onClick={() => {
              s.setName(s.nameEdit)
              s.setPanel("main")
            }}
          />
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <ProfileCTA
            ...
            onClick={() => {
              ...
              s.setPwNew("")
              s.setPwConfirm("")
              setTimeout(() => s.setPwSaved(false), 3000)
            }}
          />
        </div>
      </SubPage>
          ...
          {DICT_LIST.map((d, i) => (
            ...
            >
              ...
              <Toggle
                ...
                onToggle={() =>
                  s.setDictToggles((t) => ({ ...t, [d.id]: !t[d.id] }))
                }
              />
            </div>
          ))}
    ...
    >
      ...
      >
        ...
        <div className="flex gap-0 mt-6 w-full px-4">
          {[
            { label: "Palavras salvas", value: String(SAVED_WORDS.length) },
