...
export function MobileDefinitionPage({
  ...
  return (
    <div
      className="h-[calc(100vh-64px)] bg-[#fbf9f6] flex flex-col overflow-hidden"
      style={{
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 py-5">
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-2">
              <span
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-[24px] text-white font-['Poppins:SemiBold'] text-[11px]"
            ...
            {activeEntry.etymology && (
              <div className="flex flex-col gap-2">
                <span className="font-['Poppins:SemiBold'] text-[10px] uppercase tracking-[0.9px] text-[#8c8a82]">
                  Etimologia
                </span>
              ...
              <div className="flex flex-col gap-4">
                {activeEntry.senses.map((sense) => (
                  <div key={sense.num} className="flex gap-3">
                    <span className="font-['Poppins:Bold'] text-[12px] text-[#8c8a82] shrink-0 w-5 pt-[2px]">
                      {sense.num}.
                    </span>
                    <div className="flex flex-col gap-2 flex-1 min-w-0">
                      <div className="flex flex-wrap gap-1.5 items-start">
                        {sense.labels?.map((l) => (
                          <span
                            key={l}
                            className="font-['Poppins:SemiBold'] text-[9px] uppercase tracking-[0.5px] border border-[#c8c4bc] text-[#7e7676] rounded-[4px] px-1.5 py-0.5"
                          >
                            {l}
                          </span>
                        ))}
            ...
            <div className="flex flex-col gap-3 pt-4 border-t border-[#e0ddd6] pb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {wordData.facts.map((f) => (
                  <div
                    key={f.label}
                    className="bg-white rounded-[12px] p-3.5 border border-[#efece6]"
                  >
                    <span className="font-['Poppins:Regular'] text-[9px] uppercase tracking-[0.6px] text-[#8c8a82] block mb-1">
                      {f.label}
                    </span>
