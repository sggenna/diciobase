...
export function MobileAuthPage({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <div
      className="min-h-screen bg-[#fbf9f6] flex flex-col justify-center px-6 py-8"
    ...
    >
      ...
      {/* Mode switcher */}
      <div
        className="bg-[#efece6] rounded-[14px] p-[4px] flex mb-6"
      ...
      <div className="flex flex-col gap-5" style={slideUpStyle(vis, 0.1)}>
        <div className="flex flex-col gap-1.5">
          <label className="font-['Poppins:Medium'] text-[13px] text-[#1c1b19]">
            E-mail
          </label>
          <input
            type="email"
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            ...
            {mode === "entrar" && (
              <button className="font-['Poppins:SemiBold'] text-[13px] text-[#1c1b19]">
                Esqueceu?
              </button>
            )}
          </div>
      ...
      <div className="flex flex-col gap-5 mt-8" style={slideUpStyle(vis, 0.14)}>
        ...
        <div className="flex gap-3">
          <button className="flex-1 h-[50px] bg-white border border-[#e0ddd6] rounded-[12px] flex items-center justify-center gap-2 active:scale-[0.97] transition-transform">
            ...
            <span className="font-['Poppins:SemiBold'] text-[14px] text-[#1c1b19]">
              Google
            </span>
          </button>
          <button className="flex-1 h-[50px] bg-white border border-[#e0ddd6] rounded-[12px] flex items-center justify-center gap-2 active:scale-[0.97] transition-transform">
