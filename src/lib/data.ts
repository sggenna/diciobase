...
export const DB: Record<string, WordData> = {
  efêmero: {
    ...
    dicts: [
      {
        id: "aurelio",
        name: "Dicionário Aurélio",
        shortName: "Aurélio",
        tag: "Versão 2026",
        etymology:
          "Do grego epheméros 'que dura um dia', pelo latim ephemerus.",
        senses: [
          {
            num: "1",
            text: "Que dura apenas um dia.",
            examples: ['"As flores efêmeras do ipê caem ao amanhecer."'],
          },
          {
            num: "2",
            text: "Que tem curta duração; passageiro, transitório.",
            subsenses: [
              {
                num: "2.1",
                text: "Diz-se de fenômeno ou estado que se extingue rapidamente.",
              },
              {
                num: "2.2",
                text: "Diz-se de publicação periódica de vida curta.",
              },
            ],
            examples: [
              '"A glória efêmera dos vencedores."',
              '"Seu sucesso mostrou-se efêmero."',
            ],
          },
          {
            num: "3",
            text: "Perecível; mortal.",
            labels: ["Figurado"],
            examples: ['"A existência efêmera dos seres vivos."'],
          },
        ],
      ...
      {
        id: "houaiss",
        name: "Dicionário Houaiss",
        shortName: "Houaiss",
        tag: "Edição Integral",
        etymology:
          "Gr. ephḗmeros 'que dura um dia', de epí 'sobre' + hḗmera 'dia'; ver efemer(o)-.",
        senses: [
          {
            num: "1",
            text: "Que dura ou existiu somente durante um dia.",
            labels: ["Entomologia"],
            examples: [
              '"Insetos efêmeros, como a efeméride, vivem apenas algumas horas como adultos."',
            ],
          },
          {
            num: "2",
            text: "Que tem existência ou validade por muito curto tempo; que passa ou desaparece rapidamente.",
            subsenses: [
              {
                num: "2.1",
                text: "Diz-se de prazer, sentimento ou situação de breve duração.",
              },
              {
                num: "2.2",
                text: "Diz-se de produto ou obra cultural de consumo rápido e sem valor duradouro.",
              },
              {
                num: "2.3",
                text: "Relativo a publicação periódica de interesse momentâneo.",
              },
            ],
            examples: [
              '"A moda é efêmera por natureza."',
              '"Produções efêmeras que logo caem no esquecimento."',
            ],
          },
          {
            num: "3",
            text: "Que é passageiro, provisório, de pouca importância.",
            labels: ["Figurado"],
          },
        ],
        notes: [
      ...
      },
      {
        ...
        senses: [
          ...
          {
            num: "2",
            text: "Que dura pouco; passageiro.",
            examples: [
              '"A felicidade não é efêmera para quem sabe valorizá-la."',
            ],
          },
          {
            num: "3",
            text: "Que é de pouca importância; insignificante.",
            labels: ["Popular"],
          },
        ],
    ...
    dicts: [
      {
        ...
        senses: [
          ...
          {
            num: "2",
            text: "Porção de terra delimitada; lote.",
            examples: ['"Comprou um terreno na periferia."'],
          },
          {
            num: "3",
            text: "Campo de ação, esfera de atividade.",
            labels: ["Figurado"],
          },
          {
            num: "4",
            text: "Conjunto das condições físicas de determinado lugar.",
            labels: ["Geologia"],
          },
        ],
      ...
      },
      {
        ...
        senses: [
          {
            num: "1",
            text: "Superfície de terra; solo.",
            examples: ['"O terreno é fértil e propício ao cultivo."'],
          },
          {
            num: "2",
            text: "Faixa ou área de terra com limites definidos.",
            subsenses: [
              { num: "2.1", text: "Lote urbano destinado à construção." },
              {
                num: "2.2",
                text: "Propriedade rural sem benfeitorias significativas.",
              },
            ],
          },
          {
            num: "3",
            text: "Conjunto de formações geológicas de uma região.",
            labels: ["Geologia"],
          },
          {
            num: "4",
            text: "Âmbito, esfera, domínio.",
            labels: ["Figurado"],
            examples: [
              '"No terreno da filosofia, a questão permanece aberta."',
            ],
          },
        ],
      ...
      },
      {
        ...
        senses: [
          { num: "1", text: "Extensão de terra." },
          {
            num: "2",
            text: "Lote de terra.",
            examples: ['"Eles compraram um terreno para construir."'],
          },
          {
            num: "3",
            text: "Espaço ou área de atuação.",
            labels: ["Figurado"],
          },
        ],
    ...
    dicts: [
      {
        ...
        senses: [
          {
            num: "1",
            text: "Edificação destinada à habitação humana.",
            examples: ['"A casa foi reformada no ano passado."'],
          },
          {
            num: "2",
            text: "Residência, lar.",
            examples: ['"Saudades de casa."'],
          },
          { num: "3", text: "Família, grupo doméstico.", labels: ["Figurado"] },
          {
            num: "4",
            text: "Estabelecimento comercial.",
            examples: ['"Casa de câmbio, casa de penhores."'],
          },
          {
            num: "5",
            text: "Cada uma das divisões de um tabuleiro de jogo.",
            labels: ["Jogos"],
          },
        ],
      ...
      },
      {
        ...
        senses: [
          {
            num: "1",
            text: "Construção destinada à moradia.",
            subsenses: [
              { num: "1.1", text: "Moradia unifamiliar de pequeno porte." },
              {
                num: "1.2",
                text: "Moradia em geral, independentemente do porte.",
              },
            ],
          },
          {
            num: "2",
            text: "O lar, o ambiente doméstico familiar.",
            examples: ['"Chegou em casa tarde da noite."'],
          },
          { num: "3", text: "Família; linhagem nobre.", labels: ["Histórico"] },
          {
            num: "4",
            text: "Estabelecimento comercial ou industrial.",
            examples: ['"Casa editorial, casa bancária."'],
          },
          {
            num: "5",
            text: "Subdivisão de uma tabela, grade ou tabuleiro.",
            labels: ["Tipografia", "Jogos"],
          },
        ],
        synonyms: [
          "lar",
      ...
      },
      {
        ...
        senses: [
          { num: "1", text: "Construção onde se mora." },
          {
            num: "2",
            text: "Lar, residência.",
            examples: ['"Fique em casa."'],
          },
          {
            num: "3",
            text: "Negócio, empresa.",
            examples: ['"Casa de moda."'],
          },
        ],
    ...
    dicts: [
      {
        ...
        senses: [
          {
            num: "1",
            text: "Veículo automóvel de passeio.",
            examples: ['"Comprou um carro novo."'],
          },
          {
            num: "2",
            text: "Veículo de tração animal com rodas.",
            labels: ["Histórico"],
          },
          {
            num: "3",
            text: "Elemento de destaque; ponto alto.",
            labels: ["Figurado"],
      ...
      },
      {
        ...
        tag: "Edição Integral",
        etymology:
          "Lat. carrus, i 'carro de quatro rodas', do gaulês; ver carr(o)-.",
        senses: [
          {
            num: "1",
            text: "Veículo automóvel destinado ao transporte de pessoas.",
            subsenses: [
              { num: "1.1", text: "Automóvel de passeio de pequeno porte." },
              {
                num: "1.2",
                text: "Qualquer automóvel, independentemente do porte.",
              },
            ],
          },
          {
            num: "2",
            text: "Veículo de rodas movido por tração animal.",
            labels: ["Histórico"],
          },
          {
            num: "3",
            text: "O que mais se destaca ou tem maior valor em um conjunto.",
            labels: ["Figurado"],
      ...
      },
      {
        ...
        senses: [
          ...
          {
            num: "2",
            text: "Veículo com rodas puxado por animais.",
            labels: ["Histórico"],
          },
        ],
...
export const SAVED_WORDS = [
  {
    word: "merencória",
    pos: "adj.",
    snippet: "Diz-se de pessoa melancólica, triste, tristonha.",
    when: "há 2 dias",
  },
  {
    word: "vellichor",
  ...
  },
  {
    word: "efêmero",
    pos: "adj.",
    snippet: "Que dura apenas um dia; passageiro, transitório.",
    when: "há 1 semana",
  },
  {
    word: "sussurro",
    pos: "subst.",
    snippet: "Ruído brando e contínuo; som de vozes em tom baixo.",
    when: "há 2 semanas",
  },
  {
    word: "apricidade",
    pos: "subst.",
    snippet: "O calor agradável do sol em pleno inverno.",
    when: "há 1 mês",
  },
]
